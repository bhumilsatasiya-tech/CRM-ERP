...
return [
    ...
    */
    ...
    'providers' => [
        ...
        /*
         * Module Service Providers (CRM+ERP)
         */
        ...
        Modules\Quotation\Providers\QuotationServiceProvider::class,
        Modules\Sales\Providers\SalesServiceProvider::class,
        Modules\Production\Providers\ProductionServiceProvider::class,
        Modules\Formula\Providers\FormulaServiceProvider::class,
        Modules\Export\Providers\ExportServiceProvider::class,
        Modules\Irm\Providers\IrmServiceProvider::class,
        Modules\InterCompany\Providers\InterCompanyServiceProvider::class,
        Modules\Tracking\Providers\TrackingServiceProvider::class,
        Modules\Documents\Providers\DocumentsServiceProvider::class,
        Modules\Finance\Providers\FinanceServiceProvider::class,
        Modules\Loans\Providers\LoansServiceProvider::class,
        Modules\Hr\Providers\HrServiceProvider::class,
        Modules\Tasks\Providers\TasksServiceProvider::class,
        Modules\Comms\Providers\CommsServiceProvider::class,
        Modules\Reports\Providers\ReportsServiceProvider::class,
        Modules\Dashboard\Providers\DashboardServiceProvider::class,
        Modules\ExportIncentives\Providers\ExportIncentivesServiceProvider::class,
        Modules\Templates\Providers\TemplatesServiceProvider::class,
